...
export default function Disclosures() {
  return (
    <LegalPage
      title="California Real Estate Disclosures | Triple Diamond Realty"
      description="Required California real estate disclosures from Triple Diamond Realty: DRE license, Equal Housing, AS-IS terms, Natural Hazard, Megan's Law, RESPA AfBA, Clear Cooperation, and §1632 language of negotiation."
      path="/disclosures"
      heading="Required Disclosures"
    >
      <h2>1. Brokerage License (Bus. &amp; Prof. Code §10140.6)</h2>
      <p>Triple Diamond Realty • CA DRE Broker License #[INSERT] • Responsible Broker [NAME], CA DRE #[INSERT].</p>

      <h2>2. Equal Housing Opportunity</h2>
      <p>Triple Diamond Realty is an Equal Housing Opportunity brokerage and complies with the federal Fair Housing Act, California FEHA, and Unruh Civil Rights Act.</p>
      ...
      <p>Triple Diamond may have business relationships with affiliated title, escrow, or lending providers. A written Affiliated Business Arrangement Disclosure will be provided at or before any referral. Use of referred providers is voluntary.</p>
