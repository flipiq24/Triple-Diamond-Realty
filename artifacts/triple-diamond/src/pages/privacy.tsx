...
export default function Privacy() {
  return (
    <LegalPage
      title="Privacy Policy | Triple Diamond Realty"
      description="Triple Diamond Realty Privacy Policy — how we collect, use, and protect personal information under the California CCPA/CPRA. Includes Do Not Sell and Global Privacy Control."
      path="/privacy"
      heading="Privacy Policy"
    >
      <p>
        Triple Diamond Realty ("Triple Diamond," "we," "us") respects your privacy. This Policy explains how we collect, use, disclose, and protect personal information when you use our website, mobile app, deal alerts, SMS, email, or any related services ("Services"), and describes the rights of California residents under the California Consumer Privacy Act (CCPA), as amended by the California Privacy Rights Act (CPRA).
      </p>
      ...
      <p>If Triple Diamond refers you to an affiliated title, escrow, lender, or other settlement service provider in which we have an ownership interest, you will receive a written AfBA Disclosure at or before the referral as required by RESPA. You are not required to use any referred provider.</p>
      ...
      <p>To exercise CCPA/CPRA rights: email <a href="mailto:privacy@tdrealty.net">privacy@tdrealty.net</a>, call <a href="tel:+19092804906">(909) 280-4906</a>, or use the <a href="/do-not-sell">Do Not Sell or Share My Personal Information</a> link in the site footer. We will verify your identity and respond within 45 days (extendable by 45 days as permitted).</p>
      ...
      <p>The Services are not directed to children under 18. We do not knowingly collect personal information from minors. If you believe we have, contact <a href="mailto:privacy@tdrealty.net">privacy@tdrealty.net</a>.</p>
      ...
      <h2>14. Contact</h2>
      <p>Triple Diamond Realty — Privacy Officer, [INSERT ADDRESS], (909) 280-4906, <a href="mailto:privacy@tdrealty.net">privacy@tdrealty.net</a>.</p>
    </LegalPage>
  );
}
